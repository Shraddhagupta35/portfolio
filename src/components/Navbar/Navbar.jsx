...
const Navbar = () => {
  ...
  const menuItems = [
    ...
    { id: "certifica", label: "Certificates" },
  ]
  return (
    <nav className={`fixed top-0 w-full z-50 transition duration-300 px-[7vw] md:px-[7vw] lg:px-[20vw] ${isScrolled ? "bg-[#050414] bg-opacity-50 backdrop-blur-md shadow-md" : "bg-transparent"
      ...
      <div className="text-white py-5 flex justify-between items-center">
        <div className="text-lg font-semibold cursor-pointer">
          ...
          <span className="text-white">Shraddha</span>
          <span className="text-[#8245ec]">/</span>
        ...
        <ul className="hidden md:flex space-x-8 text-gray-300">
          {menuItems.map((item) => (
            <li key={item.id} className={`cursor-pointer hover:text-[#8245ec] ${activeSection === item.id ? "text-[#78245ec]" : ""}`}>
        ...
        <div className="hidden md:flex space-x-4">
          <a href="https://github.com/Shraddhagupta35"
            target="_blank"
          ...
          <a href="https://www.linkedin.com/in/shraddha-gupta-a33057248/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]"
          >
